...
class FarmClient:
    ...
    def stream(self, method, url, **kwargs):
        self.calls.append((method, url))
        self.bodies.append(kwargs.get("json") or {})  # calls and bodies stay index-aligned
...
async def test_context_meter_reports_the_budget_that_triggers_trimming(bundle):
    ...
    # The meter also carries an approximate token budget and the cache accounting of the last
